...
class CursoServiceTest{
    ...
    @Test
    void testAddNewCursoProfesorNulo(){
        Curso curso = new Curso();
        curso.setProfesor(null);

        Exception ex = assertThrows(RuntimeException.class, () -> cursoService.addNewCurso(curso));
        assertEquals("Debe asignar un profesor al curso.", ex.getMessage());
    }

    @Test
    void testAddNewCursoProfesorVacio(){
        Curso curso = new Curso();
...
// ojo pendiente revision 
    ...
    @Test
    void modificarCursosDeProfesorIdsNulosAgregar(){
        Usuario profesor = new Usuario();
        profesor.setId(1L);

        Roles roles = new Roles();
        roles.setNombre("PROFESOR");
        profesor.setRoles(roles);

        CursoPatchDTO dto = new CursoPatchDTO();
        dto.setIdsAgregar(null);

        when(usuarioRepository.findById(profesor.getId())).thenReturn(Optional.of(profesor));
        cursoService.modificarCursosDeProfesor(profesor.getId(), dto);
        verify(cursoRepository, never()).findAllById(any());
    }

    @Test
    void modificarCursosDeProfesorIdsVaciosAgregar(){
        Usuario profesor = new Usuario();
        profesor.setId(1L);
        ...
        CursoPatchDTO dto = new CursoPatchDTO();
        dto.setIdsAgregar(List.of());

        when(usuarioRepository.findById(profesor.getId())).thenReturn(Optional.of(profesor));

        cursoService.modificarCursosDeProfesor(profesor.getId(), dto); // <-- Faltaba esta línea

        verify(cursoRepository, never()).findAllById(any());
    }

    @Test
    void modificarCursosDeProfesorIdsNulosEliminar(){
        Usuario profesor = new Usuario();
        profesor.setId(1L);
    ...
    @Test
    void modificarCursosDeProfesorIdsVaciosEliminar(){
        Usuario profesor = new Usuario();
        profesor.setId(1L);
    ...
    @Test
    void modificarCursosDeProfesorValidacionIdsTodoCorrecto(){
        Usuario profesor = new Usuario();
        profesor.setId(1L);
        ...
        CursoPatchDTO dto = new CursoPatchDTO();
        List<Long> idsEliminar = List.of(100L, 200L);
        dto.setIdsEliminar(idsEliminar);
        ...
        when(usuarioRepository.findById(profesor.getId())).thenReturn(Optional.of(profesor));
        when(cursoRepository.findAllById(idsEliminar)).thenReturn(List.of(curso));
        when(cursoRepository.save(any(Curso.class))).thenAnswer(invocation -> invocation.getArgument(0));
    ...
    @Test
    void modificarCursosDeProfesorCursoOtroProfesor() {
        Usuario profesor = new Usuario();
        profesor.setId(1L);
        Roles roles = new Roles();
        roles.setNombre("PROFESOR");
        ...
        otroProfesor.setId(2L);
        Roles roles2 = new Roles();
        roles2.setNombre("PROFESOR");
        otroProfesor.setRoles(roles2);

        CursoPatchDTO dto = new CursoPatchDTO();
        List<Long> idsEliminar = List.of(200L);
        dto.setIdsEliminar(idsEliminar);

        Curso curso = new Curso();
        curso.setIdCurso(200L);
        curso.setProfesor(otroProfesor);
        ...
        assertEquals(otroProfesor, curso.getProfesor());
        verify(cursoRepository, never()).save(curso);
    }

    @Test
    void modificarCursosDeProfesorCursoSinProfesor() {
        Usuario profesor = new Usuario();
        profesor.setId(1L);
        Roles roles = new Roles();
        roles.setNombre("PROFESOR");
        ...
        CursoPatchDTO dto = new CursoPatchDTO();
        List<Long> idsEliminar = List.of(300L);
        dto.setIdsEliminar(idsEliminar);

        Curso curso = new Curso();
        curso.setIdCurso(300L);
        curso.setProfesor(null);
